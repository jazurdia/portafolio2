const aboutmeSP = {
    name: "ALEJANDRO AZURDIA",
    info:
    " Estudiante de Ingeniería en Computación, apasionado por el desarrollo web y apuntando a ser FullStack Developer. Me encanta aprender y siempre estoy buscando nuevos desafíos."
}

const frontendSP = {
    title: "Frontend",
    desc: "Valoro los diseños simples, creativos, eficientes y responsivos. Me decanto por la estética minimalista y la usabilidad.",
}

const backendSP = {
    title: "Backend",
    desc: "Me enfoco en desarollar soluciones eficientes y escalables, asegurando un alto rendimiento y una gestión adecuada del lado del servidor.",
}

const otherTechSP = {
    title: "Otras tecnologías",
    desc: "El desarollo web es un campo muy amplio, por lo que siempre estoy aprendiendo nuevas tecnologías y herramientas para mejorar mis habilidades.",
}
